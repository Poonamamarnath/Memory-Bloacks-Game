...
char textd[]={"Mr.Vasantha kumara M"};

char textg[]={"Poonam (4GH20CS407)"};

char texte[]={"Dr.T G Basavaraju"};
...
char textk[]={"Asst. Professor"};
char texts[]={"Number of Hits:"};
...
static GLfloat theta1;
  void selects() //to select inner pattern
   {
       ...
       switch(r)
       {
        case 1:glColor3f(1,0,0);glutSolidSphere(10,30,30);break;//red sphere
        ...
        case 6:glColor3f(1,0,0);glutSolidSphere(10,30,30);break;//red sphere

        case 7:glColor3f(1,0,0);glutSolidCube(10);break;//white cube
        ...
        case 16:glColor3f(1,0,0);glutSolidCube(10);break;//white cube
  ...
  void  mycube()    //draw cube
   {
	glColor3f(0.0,1.0,1.0);     // front facing cubes
	glBegin(GL_POLYGON);            //cubes when selected
   ...
   {
	glColor3f(1.0,0.0,0.0);       //left facing
	glBegin(GL_POLYGON);
	glVertex3fv(cube[1]);
	glVertex3fv(cube[0]);
	glVertex3fv(cube[6]);
	...
	glColor3f(0.0,1.0,0.0);           //top facing
	glBegin(GL_POLYGON);
	glVertex3fv(cube[5]);
	glVertex3fv(cube[7]);
	glVertex3fv(cube[6]);
	...
	glColor3f(0.0,0.0,1.0);             //rights facing
	glBegin(GL_POLYGON);
	glVertex3fv(cube[2]);
	glVertex3fv(cube[3]);
	glVertex3fv(cube[5]);
	...
	glColor3f(1.0,1.0,0.0);         // down facing
	glBegin(GL_POLYGON);
	glVertex3fv(cube[0]);
	glVertex3fv(cube[1]);
	glVertex3fv(cube[3]);
  ...
  void disp()     //routine to rotate cube
   {
	...
	glColor3f(1.0,0.0,0.0); //when selecting the blocks
	   ...
	   if(k==0)
		{
		 ...
		 else
		  {
		  ...
		  else if(f==0)
		   {
			  ...
			  else   // by default help options have to be printed
		 	   {
		 	       if(no_of_enters>=1) {
int scorehit[]={0,0,0,0};

int rem1=0;

int enter=no_of_enters;
	  j=3;
char scorehi[]={'0','0','0','0','\0'};
	   ...
	   while(enter!=0)
	  {
	   ...
	   for(j=0;j<4;j++)
	   scorehi[j]=(scorehit[j]+48);

 glColor3f(0,0,1);
				 glRasterPos3f(-20,65,0);
				 for(j=0;texts[j]!='\0';j++)
				 glutBitmapCharacter(GLUT_BITMAP_9_BY_15,texts[j]);
				  glColor3f(0,0,1);
				 glRasterPos3f(-50,65,0);
				 for(j=0;scorehi[j]!='\0';j++)
				 glutBitmapCharacter(GLUT_BITMAP_9_BY_15,scorehi[j]);
		...
		glColor3f(1.0,0.0,0.0);  // default selecting block
		rectangle(x1,yl,x2,y2,x3,y3,x4,y4);
		glFlush();
	   ...
	   void mykey(unsigned char key,int x,int y) //function to handle "normal" key presses
		...
		case 'h': h=1;
			  glutPostRedisplay();
			   ...
			   break;
		case 'x':glRotatef(3,1,0,0);glutPostRedisplay();break;
		case 'X':glRotatef(3,-1,0,0);glutPostRedisplay();break;
		case 'y':glRotatef(3,0,1,0);glutPostRedisplay();break;
		case 'Y':glRotatef(3,0,-1,0);glutPostRedisplay();break;
		case 'z':glRotatef(3,0,0,1);glutPostRedisplay();break;
		case 'Z':glRotatef(3,0,0,-1);glutPostRedisplay();break;
...
switch(value)
    {
        ...
        case 7:glRotatef(3,1,0,0);glutPostRedisplay();break;
	case 8:glRotatef(3,-1,0,0);glutPostRedisplay();break;
	case 9:glRotatef(3,0,1,0);glutPostRedisplay();break;
	case 10:glRotatef(3,0,-1,0);glutPostRedisplay();break;
	case 11:glRotatef(3,0,0,1);glutPostRedisplay();break;
	case 12:glRotatef(3,0,0,-1);glutPostRedisplay();break;
        }

}

void memory_menu(int value)
{
    switch(value)
    {

	case 14:initialize();randm();glutPostRedisplay();break;
        case 13 :exit(0);
...
int main(int argc,char **argv)  //main routine
	...
	int submenu2;
 	submenu2=glutCreateMenu(rotate1);
 	glutAddMenuEntry("Rotate by +X axis", 7);
	glutAddMenuEntry("Rotate by -X axis", 8);
	glutAddMenuEntry("Rotate by +Y axis", 9);
	glutAddMenuEntry("Rotate by -Y axis", 10);
	glutAddMenuEntry("Rotate by +Z axis", 11);
	glutAddMenuEntry("Rotate by -Z axis", 12);	
	glutCreateMenu(memory_menu);
	glutAddSubMenu("Rotate",submenu2);
	glutAddMenuEntry("Reset the Game",14);
	glutAddMenuEntry("Exit game", 13);
